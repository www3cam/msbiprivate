...
global M_ oo_ options_ nEpsilon nMeasure i_Epsilon i_Measure ssigmaMeas...
    simul_data_micro_aux simul_data_micro sim_struct_moments sim_struct_moments2
...
% Add measurement error to aggregate variables
sim_struct.logAggregateOutput_noerror = sim_struct.logAggregateOutput;
sim_struct.logAggregateOutput = sim_struct.logAggregateOutput + ssigmaMeas(1)*randn(T,1);
    
sim_struct.logAggregateInvestment_noerror = sim_struct.logAggregateInvestment;
sim_struct.logAggregateInvestment = sim_struct.logAggregateInvestment + ssigmaMeas(2)*randn(T,1);

sim_struct.logAggregateConsumption_noerror = sim_struct.logAggregateConsumption;
sim_struct.logAggregateConsumption = sim_struct.logAggregateConsumption + ssigmaMeas(3)*randn(T,1);

sim_struct.logWage_noerror = sim_struct.logWage;
sim_struct.logWage = sim_struct.logWage + ssigmaMeas(4)*randn(T,1);
