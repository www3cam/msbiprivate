...
#goes with this file: 'reiter_RBC_po.csv'
#with these parameters [[.95,.80,.8,.1,1.2, .75,1.5,.06,.15,.6]]
...
def iter_mp(queue, likewrapper1, arraystart1, iters1, seed2):
    # model = rw_metroplolis_sampler()
    queue.put(kernelfunct(likewrapper1, arraystart1, iters1, seed2))
    
# x = solve_and_sim_reiter(torch.tensor([.95,.80,.8,.1,1.2, .75,1.5,.06,.15,.6], dtype = torch.float32))
# np.savetxt('reiter_RBC_po2.csv', x, delimiter = ',')
# otime = time.time()
# print(likelihood_reiter_po(np.array([.95,.80,.8,.1,1.2, .75,1.5,.06,.15,.6]), xdata))
# print(time.time() - otime)

#x = solve_and_sim_reiter(torch.tensor([[.95,.80,.8,.1,1.2, .75,1.5,.06,.15,.6]], dtype = torch.float32))

# np.savetxt('reiter_RBC_po.csv', x, delimiter = ',')
# n_samples = 1000
